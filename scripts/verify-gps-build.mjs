...
const checks=[
  ...
  ['Android API 31+ fused provider fallback',native.includes('LocationManager.FUSED_PROVIDER')],
  ['Android updates are requested every second',native.includes('requestLocationUpdates')&&native.includes('1000L')],
  ['Android reuses last known location',native.includes('getLastKnownLocation')],
